...
public class DonationService {
    ...
    @Transactional
    public Donation submitDonation(String donorEmail,
        ...
        log.info("Donation created (local): donationId={}, donor={}, amount={}", donation.getId(), donor.getEmail(), amount);
        ...
        try {
            ...
            log.error("Failed to submit payment to Vola for paymentId={} donationId={}", payment.getId(), donation.getId(), e);
        }
